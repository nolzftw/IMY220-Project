...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee22() {
    ...
    return _regeneratorRuntime().wrap(function _callee22$(_context22) {
      while (1) switch (_context22.prev = _context22.next) {
              ...
              return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  ...
                  case 10:
                    ...
                    console.error('Error creating playlist:', _context9.t0);
                    res.status(500).json({
              ...
              return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                while (1) switch (_context10.prev = _context10.next) {
                  ...
                  case 28:
                    ...
                    console.error('Error adding song to playlist:', _context10.t0);
                    res.status(500).json({
                ...
                while (1) switch (_context12.prev = _context12.next) {
                  ...
                  case 7:
                    ...
                    return Promise.all(playlist.songs.map(/*#__PURE__*/function () {
                      var _ref12 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11(songId) {
                        var song;
              ...
              return _regeneratorRuntime().wrap(function _callee13$(_context13) {
                while (1) switch (_context13.prev = _context13.next) {
                  ...
                  case 24:
                    ...
                    console.error('Error updating playlist:', _context13.t0);
                    res.status(500).json({
              ...
              return _regeneratorRuntime().wrap(function _callee14$(_context14) {
                while (1) switch (_context14.prev = _context14.next) {
                  ...
                  case 17:
                    ...
                    console.error('Error deleting playlist:', _context14.t0);
                    res.status(500).json({
              ...
              return _regeneratorRuntime().wrap(function _callee15$(_context15) {
                while (1) switch (_context15.prev = _context15.next) {
                  ...
                  case 23:
                    ...
                    console.error('Error creating or updating song:', _context15.t0);
                    res.status(500).json({
              ...
              return _regeneratorRuntime().wrap(function _callee16$(_context16) {
                while (1) switch (_context16.prev = _context16.next) {
                  ...
                  case 19:
                    ...
                    console.error('Error marking song as deleted:', _context16.t0);
                    res.status(500).json({
              ...
              return _regeneratorRuntime().wrap(function _callee17$(_context17) {
                while (1) switch (_context17.prev = _context17.next) {
                  ...
                  case 11:
                    ...
                    console.error('Error searching for playlists:', _context17.t0);
                    res.status(500).json({
              ...
              return _regeneratorRuntime().wrap(function _callee18$(_context18) {
                while (1) switch (_context18.prev = _context18.next) {
                  ...
                  case 11:
                    ...
                    console.error('Error searching for songs:', _context18.t0);
                    res.status(500).json({
              ...
              return _regeneratorRuntime().wrap(function _callee19$(_context19) {
                while (1) switch (_context19.prev = _context19.next) {
                  ...
                  case 7:
                    ...
                    return _context19.abrupt("return", res.status(200).json(userProfile));
                  case 12:
                    // If the session user is viewing someone else's profile, hide email and password
                    publicProfile = {
                      _id: user._id,
                    ...
                    return _context19.abrupt("return", res.status(200).json(publicProfile));
                  case 14:
                    _context19.next = 19;
                    break;
                  case 16:
              ...
              return _regeneratorRuntime().wrap(function _callee21$(_context21) {
                while (1) switch (_context21.prev = _context21.next) {
                  ...
                  case 12:
                    ...
                    console.error('Error searching for users:', _context21.t0);
                    res.status(500).json({
        ...
        case 32:
          ...
          console.error("Error connecting to MongoDB:", _context22.t0);
        case 35:
          // Serve static files
